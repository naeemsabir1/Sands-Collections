                ...
                <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center justify-center text-center">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed max-w-xl mx-auto">
                            Refined elegance for the modern gentleman. Premium shawls and bespoke suiting fabrics.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    >
                        <h2 className="font-playfair text-3xl md:text-4xl text-white mb-6">
                            Crafted for <span className="text-gold-primary">Distinction</span>
                        </h2>
                        <p className="text-white/70 leading-relaxed mb-8">
                            Every piece in our men&apos;s collection is carefully selected for quality, comfort, and timeless style.
                            From hand-woven pashmina shawls to premium suiting fabrics, we bring you the finest materials
                        ...
                        <div className="grid grid-cols-3 gap-8">
                            ...
                            <div className="text-center">
                                <span className="block font-playfair text-3xl text-gold-primary mb-2">50+</span>
                                <span className="text-white/60 text-sm">Unique Designs</span>
                            </div>
                            <div className="text-center">
                                <span className="block font-playfair text-3xl text-gold-primary mb-2">24/7</span>
