...
const materials = ['Pure Pashmina', 'Velvet', 'Pure Cashmere', 'Merino Wool'];

export default function WomensShawlsPage() {
    ...
    useEffect(() => {
        async function loadProducts() {
            ...
            try {
                ...
                const shawlProducts = allProducts.filter(p => p.category === 'womens-shawls');
                ...
                <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed">
                            Luxurious pashmina, cashmere, and velvet shawls for the graceful woman. Timeless elegance for every occasion.
                        </p>
                    </motion.div>
                </div>
            </section>
                    ...
                    <>
                        <div className="mb-8 flex items-center justify-between">
                            <p className="text-medium-gray text-[15px]">
                                Showing <span className="font-bold text-charcoal">{filteredProducts.length}</span> luxury shawls
                            </p>
                        </div>
