...
const materials = ['Cotton', 'Terry Cotton', 'Polyester Blend'];

export default function GentsIhramPage() {
    ...
    useEffect(() => {
        async function loadProducts() {
            ...
            try {
                ...
                const ihramProducts = allProducts.filter(p => p.category === 'ihram-gents');
                ...
                <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center justify-center text-center">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed">
                            Pure and comfortable Ihram sets for Hajj and Umrah. Traditional two-piece sets in premium fabrics.
                        </p>
                    </motion.div>
                </div>
            </section>
