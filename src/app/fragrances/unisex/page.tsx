...
export default function UnisexFragrancesPage() {
    ...
    useEffect(() => {
        async function loadProducts() {
            ...
            try {
                ...
                const fragranceProducts = allProducts.filter(p => p.category === 'fragrances-unisex');
                ...
                <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed">
                            Sophisticated scents that transcend gender. Warm ambers, rich ouds, and clean musks for everyone.
                        </p>
                    </motion.div>
                </div>
            </section>
