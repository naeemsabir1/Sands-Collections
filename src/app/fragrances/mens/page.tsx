...
export default function MensFragrancesPage() {
    ...
    useEffect(() => {
        async function loadProducts() {
            ...
            try {
                ...
                const fragranceProducts = allProducts.filter(p => p.category === 'fragrances-mens');
    ...
    return (
        <div className="min-h-screen bg-off-white">
            {/* Hero Section */}
            <section className="relative h-72 md:h-96 overflow-hidden bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700">
                <div
                    className="absolute inset-0 bg-cover bg-center opacity-30"
                    style={{ backgroundImage: "url('/Mens Fragrances.webp')" }}
                />
                ...
                <div className="relative h-full container mx-auto px-4 lg:px-8 flex items-center">
                    ...
                    >
                        ...
                        <p className="text-white/80 text-lg md:text-xl font-light leading-relaxed">
                            Bold and sophisticated scents for the modern man. From intense oud to fresh aquatics.
                        </p>
                    </motion.div>
                </div>
            </section>
